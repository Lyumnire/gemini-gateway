...
export function TrashIcon({ className = base }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M4 7h16M9 7V5a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2m3 0v13a1 1 0 0 1-1 1H8a1 1 0 0 1-1-1V7M10 11v6M14 11v6" />
    </svg>
  );
}
...
export function SparkIcon({ className = base }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <path d="M12 2l1.9 5.7a4 4 0 0 0 2.5 2.5L22 12l-5.6 1.8a4 4 0 0 0-2.5 2.5L12 22l-1.9-5.7a4 4 0 0 0-2.5-2.5L2 12l5.6-1.8a4 4 0 0 0 2.5-2.5L12 2z" />
    </svg>
  );
}
